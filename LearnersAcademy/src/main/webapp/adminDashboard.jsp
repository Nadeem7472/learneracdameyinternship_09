...
try {
	...
	pst = con.prepareStatement("select * from LEARNERSTUDENTS");
	rs = pst.executeQuery();
		...
		<nav id="sidebar">
			...
			<div class="p-4">
				...
				<ul class="list-unstyled components mb-5">
					<li class="active"><a href="adminDashboard.jsp"><span
								...
								<table>
									...
									<% while(rs.next()){ %>
											<tr class="row100 body">
												...
												<td class="cell100 column3"><%= rs.getString("email") %></td>
												<td class="cell100 column4"><%= rs.getString("subject") %></td>
												<td class="cell100 column5"><a href="deleteStudent?id=<%= rs.getInt("id") %>">Delete</a></td>
											</tr>
										<%	}%>
									</tbody>
								</table>
