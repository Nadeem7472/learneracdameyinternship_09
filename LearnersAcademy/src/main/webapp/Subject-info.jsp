...
try {
	...
	pst = con.prepareStatement("select * from LEARNERSUBJECTS");
	rs = pst.executeQuery();
			...
			<div class="p-4">
				...
				<ul class="list-unstyled components mb-5">
					...
					<li><a href="Teacher-info.jsp"><span class="fa fa-user-circle-o mr-3"></span>TEACHERS
							INFO</a></li>
					<li class="active"><a href="Subject-info.jsp"><span class="fa fa-book mr-3"></span>SUBJECTS
							INFO</a></li>
								...
								<table>
									...
									<% while(rs.next()){ %>
											<tr class="row100 body">
												...
												<td class="cell100 column2"><%= rs.getString("sname") %></td>
												<td class="cell100 column4"><%= rs.getString("time") %></td>
												<td class="cell100 column5"><a href="DeleteSubject?id=<%= rs.getInt("id") %>">Delete</a></td>
											</tr>
										<%	}%>
									</tbody>
								</table>
