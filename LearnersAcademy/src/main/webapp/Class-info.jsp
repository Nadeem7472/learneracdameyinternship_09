...
if(session.getAttribute("admin_Email")!=null && request.getParameter("subName")==null)
{
	response.sendRedirect("Show-ClassReport.jsp");
}
...
try {
	...
	pst = con.prepareStatement("select LEARNERSTUDENTS.name,LEARNERSUBJECTS.sname,LEARNERSUBJECTS.time,LEARNERTEACHERS.tname from LEARNERSTUDENTS,LEARNERSUBJECTS,LEARNERTEACHERS where LEARNERSUBJECTS.sname=LEARNERTEACHERS.tsubject and LEARNERSTUDENTS.subject=LEARNERSUBJECTS.sname and LEARNERSUBJECTS.sname='"+subName+"'");
	rs = pst.executeQuery();
		...
		<nav id="sidebar">
			...
			<div class="p-4">
				...
				<ul class="list-unstyled components mb-5">
					...
					<li><a href="Teacher-info.jsp"><span class="fa fa-user-circle-o mr-3"></span>TEACHERS
							INFO</a></li>
					<li><a href="Subject-info.jsp"><span class="fa fa-book mr-3"></span>SUBJECTS
							INFO</a></li>
					<li class="active"><a href="Class-info.jsp"><span class="fa fa-sticky-note mr-3"></span>CLASS
							INFO</a></li>
								...
								<table>
									<thead>
										<tr class="row100 head">
											...
											<th class="cell100 column4">STUDENT</th>
										</tr>
								...
								<table>
									...
									<% while(rs.next()){ %>
											<tr class="row100 body">
												<td class="cell100 column1"><%= rs.getString("SNAME") %></td>
												<td class="cell100 column2"><%= rs.getString("TIME") %></td>
												<td class="cell100 column3"><%= rs.getString("TNAME") %></td>
												<td class="cell100 column4"><%= rs.getString("NAME") %></td>
											</tr>
										<%	}%>
									</tbody>
								</table>
